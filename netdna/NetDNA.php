...
require_once("NetDNA/OAuth/OAuthConsumer.php");
require_once("NetDNA/OAuth/OAuthRequest.php");
require_once("NetDNA/OAuth/OAuthSignatureMethod_HMAC_SHA1.php");
require_once("NetDNA/OAuth/OAuthUtil.php");
require_once("NetDNA/RWSException.php");
require_once("NetDNA/OAuth/OAuthSignatureMethod.php");
...
class NetDNA {
	...
	private function execute($selected_call, $method_type, $params) {
		...
		if(!empty($curl_error) || empty($json_output)) { 
			throw new RWSException("CURL ERROR: $curl_error, Output: $json_output", $headers['http_code'], null, $headers);
		}
